...
# Folder picker for the scratchpad setup wizard: opens a native FolderDialog
# (standalone qml6 process), floats/centers its window under Hyprland, and
# prints the chosen folder URI on stdout. Pattern borrowed from
# io.github.ilyazar.syncthing's proven picker.

set -euo pipefail

script_dir="$(dirname -- "$(realpath -- "${BASH_SOURCE[0]}")")"
picker_qml="$script_dir/folder-picker.qml"
picker_title="Choose your Obsidian vault folder"
